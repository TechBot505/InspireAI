export default [
    {
        name: 'Blog Title',
        description: 'An AI tool that generates blog titles depending on your blog content.',
        category: 'Blog',
        icon: 'https://cdn-icons-png.flaticon.com/128/4186/4186534.png',
        aiPrompt: 'Give me 5 blog titles in bullet points solely based on the blog niche provided and give me result in rich text editor format.',
    ...
    },
    {
        ...
        aiPrompt: 'Generate Blog Content based on title and outline provided in rich text editor format',
        form: [
            {
