    ...
    <>
      <header className="border-b py-4 px-4 sm:px-10 bg-white tracking-wide relative z-50">
        <div className="max-w-7xl w-full mx-auto flex flex-wrap items-center gap-4">
          <Link
            href="/"
            className="flex gap-2 items-center justify-center font-bold text-lg"
          >
      ...
      <div className="flex flex-col items-center bg-white">
        <div className="relative pt-28 pb-12">
          ...
          <div className="relative flex flex-col items-center max-w-screen-xl mx-auto px-8 z-10 text-center">
            ...
            <Button
              type="button"
              className="text-lg px-4 py-6 gap-2 bg-gradient-to-br from-purple-500 to to-blue-600 hover:scale-105 transition-all duration-300"
            >
              Get Started
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 max-w-7xl mx-auto gap-6 px-4 my-12">
          <div className="hover:bg-gray-100 p-6 rounded-md hover:scale-105 transition-all duration-300 cursor-pointer">
            <Settings2
              size={48}
